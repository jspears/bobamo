(function (factory) {
    if (typeof define === 'function' && define.amd) {
        ...
        define('Backbone.Form', ['Backbone', 'underscore', 'jquery'], factory);
    } else {
        // RequireJS isn't being used. Assume backbone is loaded in <script> tags
        factory(Backbone, _, jQuery);
    }
}(function (Backbone, _, $) {
    //==================================================================================================
    //TEMPLATES
...
//                           $fieldsContainer.html('');
                           ...
                           $('.bbf-placeholder', $fieldset).replaceWith($fieldsContainer.children())
    ...
    editors.Select = editors.Base.extend({
        ...
        render:function () {
            ...
            //If a function was passed, run it to get the options
                ...
                $.get(this.schema.url, function(resp){
                    self.renderOptions(resp.payload);
                });
            }
